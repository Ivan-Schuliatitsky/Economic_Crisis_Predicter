...
public class infl_data {
    public infl_data() throws Exception{
        Group group = new Group();
        URL url = new File("src/main/resources/infl.fxml").toURI().toURL();
        ...
        loader.setController(new infl_controller());
